...
<head>
    ...
    <link rel="stylesheet" href="assets/css/SmartNavClean.css">
...
<body style="background: url(&quot;assets/img/i2.jpg&quot;), #343434;margin-top: 0px;height: 100%;">
    <div class="d-flex flex-column justify-content-center" style="height: 100%;">
        <div class="d-flex d-xl-flex flex-column align-items-center align-items-xl-center" id="box-2" style="height: 100%;"><img data-aos="fade" data-aos-duration="2500" data-aos-delay="700" id="logoimage1" src="assets/img/logo_system-removebg-preview.png" style="width: 40%;margin-top: 50px;">
            <h1 data-aos="fade" data-aos-duration="2000" data-aos-delay="1300" id="heading1" style="color: rgb(255,255,255);font-weight: bold;font-size: 30px;font-family: Montserrat, sans-serif;">P2P FinTech (Pty) Ltd</h1>
            <div class="d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center">
                <lottie-player src="assets/js/78265-running-after-money-loop.json" mode="normal" style="width: 50%;" autoplay="" loop=""></lottie-player>
            </div><a href="Login" style="height: 45px;"><button class="btn btn-primary" data-bss-hover-animate="pulse" id="button1" type="button" style="height: 45px;margin-top: 0;margin-right: 0;margin-left: 0;"><img style="width: 20px;height: 20px;transform: rotate(270deg) translateX(2px);" src="assets/img/arrowwhite.gif"><span><strong>Continue</strong></span><img style="width: 20px;height: 20px;transform: rotate(90deg) translateX(-2px);" src="assets/img/arrowwhite.gif"></button></a>
        </div>
    </div>
    ...
    <script src="assets/js/Date-Range-Picker-1.js"></script>
    ...
    <script src="assets/js/SmartNavClean-1.js"></script>
    <script src="assets/js/SmartNavClean.js"></script>

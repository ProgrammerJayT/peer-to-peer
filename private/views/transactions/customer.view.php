...
<div class="d-xxl-flex flex-grow-0 justify-content-xxl-center" style="margin-left: 25px;">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h2 style="width: 343px;">My requests</h2>
            </div>
                                ...
                                if ($reqValue->prov_id == $provValue->prov_id){
                                    for ($i = 0; $i < count($allService); $i++){
                                        if ($reqValue->serv_id == $allService[$i]->serv_id){
                                            if ($reqValue->is_accepted == 0 && $reqValue->cust_approved == 0 && $reqValue->is_completed == 0) {
                                            echo /** @lang text */
                                                '<tr>
                                            <td>' . ($reqKey + 1) . '</td>
                                            ...
                                            <td>Awaiting service provider approval</td>
                                            <td>
                                                <a class="btn btn-primary" role="button"
                                                    style="border-style: none;background: rgb(200,0,0);font-size: 15px;"
                                                    href = "writefeedback?id='.$reqValue->req_id.'">
                                                        <i class="fas fa-trash d-xl-flex justify-content-xl-center align-items-xl-center"></i>
                                                </a>
                                            </td>
                                        </tr>';
                                        } else if ($reqValue->is_accepted == 1 && $reqValue->cust_approved == 0 && $reqValue->is_completed == 0) {
                                            echo /** @lang text */
                                                '<tr>
                                            <td>' . ($reqKey + 1) . '</td>
                                            <td>' . $reqValue->req_date . '</td>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" role="button"
                                                    style="border-style: none;background: rgb(0,200,250);font-size: 15px;"
                                                    href = "viewquotation?id='.$reqValue->req_id.'">
                                                    <i class="fas fa-eye d-xl-flex justify-content-xl-center align-items-xl-center"></i>
                                                </a>
                                                </td>
                                        </tr>';
                                        } else
                                            if ($reqValue->is_accepted == 1 && $reqValue->cust_approved == 1 && $reqValue->is_completed == 0) {
                                                echo /** @lang text */
                                                    '<tr>
                                            <td>' . ($reqKey + 1) . '</td> 
                                            <td>' . $reqValue->req_date . '</td>
                                            ...
                                            <td>
                                                ...
                                                if ($reqValue->is_accepted == 1 && $reqValue->cust_approved == 1 && $reqValue->is_completed == 1) {
                                                    echo /** @lang text */
                                                        '<tr>
                                            <td>' . ($reqKey + 1) . '</td>
                                            <td>' . $reqValue->req_date . '</td>
                                            ...
                                            <a class="btn btn-primary" role="button"
                                                ...
                                                href = "writefeedback?id='.$reqValue->req_id.'">Feedback</a>
                                            </td>
                                        </tr>';
                                                }

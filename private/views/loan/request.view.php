        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">How much do you need to lend?</h3>
                    <div class="card shadow mb-5" style="border-bottom-width: 5px;border-bottom-color: var(--bs-info);">
                        <div class="card-header py-3" style="height: 100px;background: var(--bs-info);"></div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                ...
                <div class="modal fade" id="toastMessage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

...
<body style="background: #343434;margin-top: 0px;height: 100%;">
    <div class="d-flex flex-column justify-content-center">
        <div class="d-flex d-xl-flex flex-column align-items-center align-items-xl-center" id="box-2"><img data-aos="fade" data-aos-duration="2500" data-aos-delay="700" id="logoimage1" src="assets/img/logo_system-removebg-preview.png" style="width: 40%;">
            <h1 data-aos="fade" data-aos-duration="2000" data-aos-delay="1300" id="heading1" style="color: rgb(255,255,255);font-weight: bold;font-size: 30px;">P2P FinTech (Pty) Ltd</h1>
            <a href="login"><button class="btn btn-primary" data-bss-hover-animate="pulse" id="button1" type="button" style="height: 45px;">
                <img style="width: 20px;height: 20px;transform: rotate(270deg) translateX(2px);" src="assets/img/arrowwhite.gif">
                <span><strong>Continue</strong></span>
                <img style="width: 20px;height: 20px;transform: rotate(90deg) translateX(-2px);" src="assets/img/arrowwhite.gif"></button></a>
        </div>
    </div>

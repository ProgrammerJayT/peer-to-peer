...
<section class="login-clean">
    <form method="post">
        ...
        <div class="illustration">
            <i class="icon ion-edit" style="color: rgb(255,138,0);"></i>
        </div>
        <div class="mb-3">
            <h6 style="text-align: center;margin-bottom:25px"><?php echo "Edit: $service"?></h6>
            <input class="form-control" type="text" name="service" placeholder="enter new service type" required="" style="text-align: center;">
        </div>
        <div class="mb-3">
            <button class="btn btn-primary d-block w-100" type="submit" style="background: rgb(38,188,0);">SAVE</button>
        </div>
    </form>
</section>

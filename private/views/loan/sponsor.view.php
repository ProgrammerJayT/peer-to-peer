<!DOCTYPE html>
<html style="background: url(&quot;assets/img/rm222batch4-mind-18.jpg&quot;);height: 100%;">
...
<body style="background: rgba(255,255,255,0);height: 100%;">
    <section class="d-xl-flex flex-column card-section-imagia" style="background: rgba(255,255,255,0);height: 100%;padding-bottom: 0px;width: 100%;">
        <div class="container" style="height: 100%;width: 100%;">
            <div class="row" style="height: 100%;">
                <div class="col-sm-6 col-md-4 d-xl-flex" style="width: 30%;height: 100%;">
                    <div class="card-container-imagia" style="border-radius: 30px;margin-bottom: 0px;height: 450px;margin-top: 50px;border-width: 1px;border-color: rgb(255,255,255);border-bottom-style: solid;">
                        <div class="card-imagia" style="height: 100px;">
                ...
                <div class="col-sm-6 col-md-4" style="width: 70%;background: rgba(255,255,255,0);height: 100%;">
                    <section class="position-relative py-4 py-xl-5" style="height: 100%;">
                                    ...
                                    <div class="card mb-5" style="background: rgba(255,255,255,0);border-style: none;height: 100%;">
                                        <div class="card-body p-sm-5" style="height: 100%;">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 d-xl-flex justify-content-xl-center"><select class="form-select display-inline-block" style="border-bottom-left-radius: 20px;border-top-left-radius: 20px;">
                                                        ...
                                                        </select><select class="form-select display-inline-block">
                                                        ...
                                                        </select><select class="form-select display-inline-block" style="border-top-right-radius: 20px;border-bottom-right-radius: 20px;">

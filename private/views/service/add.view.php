...
<body>
    ...
    <section class="login-clean">
        <form method="post">
            ...
            <div class="illustration"><i class="icon ion-ios-plus" style="color: rgb(0,163,255);"></i></div>
            <div class="d-xl-flex justify-content-xl-center mb-3">
                <h3>Add Service</h3>
            </div>
            <div class="mb-3">
                <input class="form-control" type="text" name="service" placeholder="e.g Electrician, Painting" required="">
            </div>
            <div class="mb-3">
                <button class="btn btn-primary d-block w-100" type="submit" style="background: rgb(0,148,255);">Submit</button>
            </div><a class="forgot" href="<?=ROOT?>/services">Cancel</a>
        </form>
    </section>
